...
async function runAllTests() {
    ...
    console.log(`  - ${grandTotal.passed} passed, ${grandTotal.failed} failed, ${grandTotal.skipped} skipped, ${grandTotal.total} total, ${Math.round(grandTotal.elapsed * 10)/10} sec total time`);
    console.log('');
