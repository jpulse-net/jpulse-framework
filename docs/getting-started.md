# jPulse Framework / Docs / Getting Started with jPulse v0.7.6
...
> **Future**: Once the repository is public, this will simplify to just: `npm install -g @peterthoeny/jpulse-framework`
