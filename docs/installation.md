# jPulse Framework / Docs / Site Installation Guide v0.7.11
...
npx jpulse-framework jpulse-update       # Same as npm run jpulse-update
npx jpulse-framework jpulse-update --dry-run  # Safe preview mode
```
