# jPulse Framework v0.7.3 Deployment Guide for %SITE_NAME%
...
./deploy/install-test.sh  ## Validate after update
```
...
#### Getting Help
1. **Run diagnostics**: `./deploy/install-test.sh`
...
|--------|---------|--------|------|
| `install-system.sh` | System dependencies | root | Initial setup |
| `mongodb-setup.sh` | Database configuration | app user | After system setup |
| `install-test.sh` | Deployment validation | app user | After each change |
