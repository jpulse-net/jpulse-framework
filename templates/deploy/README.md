# Deployment Guide - %SITE_NAME%, based on jPulse Framework v0.7.2
...
### Process Management
- `deploy/ecosystem.dev.config.cjs` - Development PM2 configuration
- `deploy/ecosystem.prod.config.cjs` - Production PM2 configuration (%PM2_INSTANCES% instances)
